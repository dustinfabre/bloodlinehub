...
import { Bird, Shield, Layers, Users } from 'lucide-vue-next';
...
<template>
    <Head title="Welcome to BloodlineHub" />
    
    <div class="min-h-screen bg-gradient-to-br from-blue-50 via-white to-sky-50 dark:from-gray-900 dark:via-gray-900 dark:to-blue-950">
        <!-- Navigation -->
        <nav class="fixed top-0 w-full bg-white/80 backdrop-blur-md border-b border-blue-100 dark:bg-gray-900/80 dark:border-blue-900/50 z-50">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between items-center h-16">
                    <div class="flex items-center gap-2">
                        <Bird class="h-8 w-8 text-primary" />
                    ...
                    <div class="flex items-center gap-3">
                        <Link
                            ...
                            :href="dashboard()"
                            class="px-5 py-2 rounded-lg bg-primary text-white hover:bg-primary/90 transition-colors font-medium"
                        >
                            Dashboard
                        </Link>
                        <template v-else>
                            <Link
                                :href="login()"
                                class="px-5 py-2 rounded-lg text-gray-700 hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-800 transition-colors font-medium"
                            >
                                Log in
                            </Link>
                        </template>
        ...
        <div class="pt-32 pb-20 px-4 sm:px-6 lg:px-8">
            <div class="max-w-7xl mx-auto">
                <div class="text-center mb-16">
                    <div class="inline-flex items-center justify-center mb-6">
                        <div class="p-4 bg-primary/10 rounded-2xl">
                            <Bird class="h-16 w-16 text-primary" />
                        </div>
                    </div>
                    ...
                    <p class="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto mb-8">
                        The complete CRM solution for pigeon enthusiasts. Track records, build pedigrees, 
                        showcase your collection, and manage sales with ease.
                    </p>
                    <div class="flex items-center justify-center gap-4">
                        <Link
                            v-if="!$page.props.auth.user"
                            :href="login()"
                            class="px-8 py-3 rounded-lg bg-primary text-white hover:bg-primary/90 transition-colors font-semibold text-lg shadow-lg shadow-primary/25"
                        >
                            Get Started
                        </Link>
                        <Link
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mt-20">
                    <div class="p-6 bg-white dark:bg-gray-800 rounded-xl border border-blue-100 dark:border-blue-900/50 shadow-sm hover:shadow-md transition-shadow">
                        ...
                        <p class="text-gray-600 dark:text-gray-300 text-sm">
                            Store comprehensive data including color, ring numbers, personal numbers, notes, and photos.
                        </p>
                    </div>
                    ...
                    <div class="p-6 bg-white dark:bg-gray-800 rounded-xl border border-blue-100 dark:border-blue-900/50 shadow-sm hover:shadow-md transition-shadow">
                        ...
                        <p class="text-gray-600 dark:text-gray-300 text-sm">
                            Create beautiful, printable pedigrees to showcase your pigeon's lineage and heritage.
                        </p>
                    </div>
                    ...
                    <div class="p-6 bg-white dark:bg-gray-800 rounded-xl border border-blue-100 dark:border-blue-900/50 shadow-sm hover:shadow-md transition-shadow">
                        ...
                        <p class="text-gray-600 dark:text-gray-300 text-sm">
                            Showcase your best pigeons to the world with customizable public profile pages.
                        </p>
                    </div>
                    ...
                    <div class="p-6 bg-white dark:bg-gray-800 rounded-xl border border-blue-100 dark:border-blue-900/50 shadow-sm hover:shadow-md transition-shadow">
                        ...
                        <p class="text-gray-600 dark:text-gray-300 text-sm">
                            List pigeons for sale or auction with integrated bidding and transaction management.
                        </p>
                    </div>
                </div>

                <!-- CTA Section -->
                <div class="mt-20 p-12 bg-gradient-to-br from-primary/10 to-blue-600/10 rounded-2xl border border-primary/20 text-center">
                    <h2 class="text-3xl font-bold text-gray-900 dark:text-white mb-4">
                        Ready to manage your collection?
                    </h2>
                    <p class="text-gray-600 dark:text-gray-300 mb-6 max-w-xl mx-auto">
                        Join pigeon enthusiasts who trust BloodlineHub to manage their breeding programs and showcase their birds.
                    </p>
                    <Link
                        v-if="!$page.props.auth.user"
                        :href="login()"
                        class="inline-block px-8 py-3 rounded-lg bg-primary text-white hover:bg-primary/90 transition-colors font-semibold shadow-lg shadow-primary/25"
                    >
                        Start Now
                    </Link>
                </div>
        ...
        <!-- Footer -->
        <footer class="border-t border-blue-100 dark:border-blue-900/50 py-8">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex flex-col md:flex-row justify-between items-center gap-4">
                    <div class="flex items-center gap-2">
                        <Bird class="h-6 w-6 text-primary" />
                        <span class="font-semibold text-gray-900 dark:text-white">BloodlineHub</span>
                    </div>
                    <p class="text-sm text-gray-600 dark:text-gray-400">
                        © 2025 BloodlineHub. All rights reserved.
                    </p>
                </div>
            </div>
        </footer>
